...
namespace AElf.CrossChainServer.Chains
{
    ...
    public class BlockchainAppService : CrossChainServerAppService, IBlockchainAppService
    {
        ...
        public async Task<FilterLogsAndEventsDto<TEventDTO>> GetContractLogsAndParseAsync<TEventDTO>(string chainId,
            ...
            where TEventDTO : IEventDTO, new()
        {
            ...
            return await provider.GetContractLogsAndParseAsync<TEventDTO>(chainId, contractAddress, startHeight,
                endHeight,logSignature);
        }
    }
}